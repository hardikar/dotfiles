...
hi Search		ctermfg=177		ctermbg=154		cterm=none		guifg=#d787ff	guibg=#636066	gui=none
...
hi DiffDelete	ctermfg=232		ctermbg=168		cterm=none		guifg=#242424	guibg=#3e3969	gui=none
